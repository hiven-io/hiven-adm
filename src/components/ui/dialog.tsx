        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            render={
              <Button
                variant="ghost"
                className="absolute top-3 right-3 h-7 w-7 rounded-lg text-hiven-text-3 hover:text-hiven-text hover:bg-hiven-surface transition-colors"
                size="icon-sm"
              />
            }
          >
